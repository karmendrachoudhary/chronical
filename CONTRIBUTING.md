...
- `src/capture/`: turns hook input and transcripts into Chronicle items.
...
- Action intents must stay low-risk and explicit. Add a schema change and tests for every new action.
